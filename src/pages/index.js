...
export default function Home() {
  ...
  return (
    <div className={styles["is-boxed"]}>
      <Head>
        <meta name="description" content={siteConfig.tagline} />
      </Head>
      <div className={clsx(styles["body-wrap"], styles["boxed-container"])}>
        <header className={styles["site-header"]}>
          <div className={styles["container"]}>
            <div className={styles["site-header-inner"]}>
              <div className={clsx(styles["brand"], styles["header-brand"])}>
        ...
        <main>
              ...
              <div className={styles["hero-inner"]}>
                  ...
                  >
                    ...
                    >
                      <input
                        ...
                        type="email"
                        name="email"
                        placeholder="Search something&hellip;"
                      />
                    </div>
                ...
                <div className={styles["hero-illustration"]}>
                  ...
                  <div
                    className={clsx(
                      styles["hero-square"],
                      styles["hero-square-1"],
                      styles["is-moving-object"],
                      styles["is-moving-object"]
                    )}
                  >
                    <svg
                    ...
                    >
                      <defs>
                        <linearGradient
                          ...
                          id="square-1-a"
                        >
                          <stop stopColor="#4353FF" offset="0%" />
                          <stop
                            stopColor="#4353FF"
                            stopOpacity=".32"
                            offset="100%"
                        ...
                        >
                          <stop
                            ...
                            offset="0%"
                          />
                          <stop stopColor="#43F1FF" offset="53.489%" />
                          <stop
                            stopColor="#43F1FF"
                            stopOpacity="0"
                            offset="100%"
                    ...
                    >
                      <defs>
                        ...
                        <radialGradient
                          ...
                          id="square-4-d"
                        >
                          <stop stopColor="#43F1FF" offset="0%" />
                          <stop
                            stopColor="#43F1FF"
                            stopOpacity="0"
                            offset="100%"
                      ...
                      <g fill="none" fillRule="evenodd">
                        ...
                        />
                        <path
                          d="M320 320V66C179.72 66 66 179.72 66 320h254z"
                          fill="url(#square-4-d)"
                          opacity=".16"
                        />
                        <path
                          d="M320 320V131c-104.382 0-189 84.618-189 189h189z"
                          fill="url(#square-4-e)"
                          opacity=".32"
                        />
                        <path
                          d="M320 320V196c-68.483 0-124 55.517-124 124h124z"
                          fill="url(#square-4-f)"
                        />
                      </g>
                    </svg>
                  ...
                  >
                    ...
                    >
                      ...
                      <g fill="none" fillRule="evenodd">
                        ...
                        />
                        <path
                          d="M0 0l39.459 40.249"
                          stroke="url(#square-5-c)"
                          strokeWidth="3"
                          transform="translate(-6 -6)"
                        />
                      </g>
                  ...
                  >
                    ...
                    >
                      ...
                      <g fill="none" fillRule="evenodd">
                        ...
                        />
                        <path
                          d="M69 68l39.459 40.249"
                          stroke="url(#square-6-d)"
                          strokeWidth="3"
                        />
                      </g>
                    </svg>
                  ...
                  >
                    ...
                    >
                      <defs>
                        ...
                        >
                          <stop
                            ...
                            offset="0%"
                          />
                          <stop stopColor="#43F1FF" offset="32.912%" />
                          <stop
                            stopColor="#43F1FF"
                            stopOpacity="0"
                            offset="100%"
                      ...
                      <g fill="none" fillRule="evenodd" opacity=".601">
                        ...
                        <path
                          d="M0 64V.1C22.901 1.644 41 20.709 41 44c0 7.202-1.73 14-4.798 20H0z"
                          fill="url(#square-7-b)"
                        />
                        <path
                  ...
                  <div
                    className={clsx(styles["hero-line"], styles["hero-line-1"])}
                  >
                    <svg
                      width="344"
                      height="217"
          ...
          <section className={clsx(styles["features"], styles["section"])}>
            <div className={styles["container"]}>
              <div
                className={clsx(
                  styles["features-inner"],
                ...
                <div className={styles["features-wrap"]}>
                  <div className={styles["feature"]}>
                    <div className={styles["feature-inner"]}>
                      ...
                      <p className={clsx(styles["text-sm"], styles["mb-0"])}>
                        Find new and exciting topics to dig into, and learn more
                        about the world that we live in and all the crazy sh!t
                        we&apos;ve been able to make throughout history.
                      </p>
                    </div>
                  </div>
                  <div className={styles["feature"]}>
                    <div className={styles["feature-inner"]}>
                      ...
                      <p className={clsx(styles["text-sm"], styles["mb-0"])}>
                        Read through our expert-curated pages to learn about a
                        topic in a very real, down-to-earth, probably vulgar
                        way!
                      </p>
                    </div>
                  </div>
                  <div className={styles["feature"]}>
                    <div className={styles["feature-inner"]}>
                      ...
                      <p className={clsx(styles["text-sm"], styles["mb-0"])}>
                        Know something that you'd like to contribute, either as
                        a suggestion or subject matter expert? Reach out to us
                        on GitHub via an Issue and we will try our best to get
